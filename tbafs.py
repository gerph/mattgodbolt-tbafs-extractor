...
class TBAFSArchive:
    ...
    def _riscos_decode(self, name_bytes):
        """
    ...
    def _riscos_to_posix_name(self, name):
        """
    ...
    def iter_entries(
        ...
        if dir_offset is None:
            ...
            for entry in root_entries:
                ...
                if entry.is_directory:
                    yield from self.iter_entries(
                        entry.data_offset, entry, all_dir_offsets
                    )
        else:
            ...
            for entry in entries:
                ...
                if entry.is_directory:
                    yield from self.iter_entries(
                        entry.data_offset, entry, global_boundaries
                    )
        ...
        for entry in self.iter_entries():
            if entry.is_directory:
                ...
                if with_types:
                    ...
                    # FIXME: We don't generate the ,llllllll,eeeeeeee form yet
